...
const translations = {
    en: {
        ...
        'about.experienceDesc': 'Our team has assisted semiconductor factories in process optimization, and has also implemented data analysis and AI systems for solar manufacturing plants, bringing advanced manufacturing methods to food production lines.',
    ...
    'zh-TW': {
        ...
        'about.experienceDesc': '我們團隊曾協助半導體工廠進行製程優化，也曾為太陽能製造廠導入數據分析與 AI 系統，能將先進製造業的方法實際落地到食品產線。',
        'about.stat1': '更快的實施速度',
        'about.stat2': '客戶滿意度',
        'about.stat3': '全天候支援',
    ...
    ja: {
        ...
        'about.experienceDesc': '当社のチームは、半導体工場のプロセス最適化を支援し、太陽光発電製造工場にデータ分析とAIシステムを導入し、先進的な製造手法を食品生産ラインに実装してきました。',
        'about.stat1': 'より速い実装',
        'about.stat2': '顧客満足度',
        'about.stat3': 'サポート対応',
    ...
    es: {
        ...
        'about.experienceDesc': 'Nuestro equipo ha asistido a fábricas de semiconductores en la optimización de procesos, y también ha implementado sistemas de análisis de datos e IA para plantas de fabricación solar, llevando métodos de fabricación avanzados a líneas de producción de alimentos.',
