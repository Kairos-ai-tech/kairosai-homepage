...
const translations = {
    en: {
        ...
        'products.subtitle': 'B2B AI platforms built for enterprises and lean teams',
    ...
    'zh-TW': {
        ...
        'products.subtitle': '為企業與精實團隊打造的 B2B AI 平台',
    ...
    ja: {
        ...
        'products.title': '製品紹介',
        'products.subtitle': '企業と少人数チームのためのB2B AIプラットフォーム',
    ...
    es: {
        ...
        'products.subtitle': 'Plataformas de IA B2B para empresas y equipos ágiles',
    ...
    it: {
        ...
        'products.subtitle': 'Piattaforme AI B2B per aziende e team snelli',
    ...
    fr: {
        ...
        'products.subtitle': 'Plateformes IA B2B pour les entreprises et équipes lean',
    ...
    ko: {
        ...
        'products.subtitle': '기업과 린 팀을 위한 B2B AI 플랫폼',
    ...
    de: {
        ...
        'products.subtitle': 'B2B-KI-Plattformen für Unternehmen und schlanke Teams',
        ...
        },
        {
            ...
            execute: async function() {
                return {
                    ...
                    productFamilies: {
                        b2b: ['iTech (AI + AR skills transfer)', 'vcom (AI coworkers)', 'Smart factory solutions', 'AI quality inspection', 'MES integration', 'Digital transformation consulting']
                    }
                };
            }
        }
