...
const extraI18n = {
    ...
    es: {
        ...
        'faq.a5': 'El despiece manual significa que un estimador cuenta y mide las barras a mano a partir del plano. Los plugins de detallado CAD automatizan el detallado y la generación de la planilla de doblado (BBS) dentro de una herramienta CAD, partiendo de un modelo ya dibujado. El despiece de acero con IA, como SetTime, en cambio lee directamente el plano — PDF o CAD — y detecta el diámetro, la separación y los solapes de las barras, generando cantidades y una planilla de doblado sin que un detallista tenga que construir antes el modelo.',
        'faq.q6': '¿Dónde sigue siendo importante la revisión humana en el despiece de acero con IA?',
        'faq.a6': 'El despiece de acero con IA no es totalmente automático, y SetTime no afirma que lo sea. Los detalles congestionados, las reglas de empalme y solape, y las revisiones a mitad de proyecto siguen requiriendo el criterio de un estimador. La función de SetTime es acelerar el conteo y reducir errores de planilla — los estimadores con experiencia deben revisar igualmente el resultado antes de usarlo en una oferta o una orden de fabricación.',
        'nav.news': 'Noticias',
        'news.tag': 'Noticias',
    ...
    fr: {
        ...
        'faq.a5': "Le métré manuel signifie qu'un métreur compte et mesure les barres à la main sur le plan. Les plugins de ferraillage CAO automatisent le ferraillage et la génération du bordereau de façonnage à l'intérieur d'un outil CAO, à partir d'une maquette déjà réalisée. Le métré d'armatures par IA, comme SetTime, lit directement le plan — PDF ou CAO — et détecte diamètre, espacement et recouvrements des barres, produisant quantités et bordereau de façonnage sans qu'un dessinateur ait d'abord à construire la maquette.",
