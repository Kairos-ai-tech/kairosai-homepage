...
const translations = {
    en: {
        ...
        'about.intro': 'At Kairos.ai, we bring applied AI to the construction industry. Our flagship system, SetTime, automates rebar estimation for AEC teams — and we build custom AI systems, backend infrastructure, and data platforms with the same engineering rigor.',
    ...
    'zh-TW': {
        ...
        'about.intro': '優時科技（Kairos.ai）將應用 AI 帶進營建產業。旗艦系統 SetTime 為 AEC 團隊自動化鋼筋估算；我們也以同等的工程實力打造客製 AI 系統、後端架構與數據平台。',
    ...
    ja: {
        ...
        'about.intro': 'Kairos.aiは応用AIを建設業界に届けます。旗艦システムSetTimeはAECチームの鉄筋積算を自動化。同じ技術力でカスタムAIシステム、バックエンド基盤、データプラットフォームも構築します。',
    ...
    es: {
        ...
        'about.intro': 'En Kairos.ai llevamos la IA aplicada al sector de la construcción. Nuestro sistema insignia, SetTime, automatiza la estimación de acero para equipos AEC; y construimos sistemas de IA a medida, infraestructura backend y plataformas de datos con el mismo rigor de ingeniería.',
    ...
    it: {
        ...
        'about.intro': 'In Kairos.ai portiamo l\'IA applicata al settore delle costruzioni. Il nostro sistema di punta, SetTime, automatizza il computo dei ferri per i team AEC; e realizziamo sistemi AI su misura, infrastrutture backend e piattaforme dati con lo stesso rigore ingegneristico.',
    ...
    ko: {
        ...
        'about.intro': 'Kairos.ai는 응용 AI를 건설 산업에 제공합니다. 대표 시스템 SetTime은 AEC 팀의 철근 산출을 자동화하며, 동일한 엔지니어링 역량으로 맞춤형 AI 시스템, 백엔드 인프라, 데이터 플랫폼을 구축합니다.',
    ...
    de: {
        ...
        'about.intro': 'Bei Kairos.ai bringen wir angewandte KI in die Baubranche. Unser Flaggschiff SetTime automatisiert die Bewehrungskalkulation für AEC-Teams — und wir bauen mit derselben technischen Sorgfalt maßgeschneiderte KI-Systeme, Backend-Infrastruktur und Datenplattformen.',
