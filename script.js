...
const translations = {
    ...
    fr: {
        ...
        'story.goal.desc': 'Nous voulons qu\'SetTime devienne la méthode de référence pour l\'estimation des armatures par les équipes AEC, et continuer à construire des systèmes IA, des infrastructures backend et des plateformes de données avec la même rigueur pour les équipes qui en ont besoin.',
    ...
    ko: {
        ...
        'about.intro': 'Kairos.ai는 응용 AI를 건설 산업에 제공합니다. 대표 시스템 SetTime는 AEC 팀의 철근 산출을 자동화하며, 동일한 엔지니어링 역량으로 맞춤형 AI 시스템, 백엔드 인프라, 데이터 플랫폼을 구축합니다.',
        ...
        'story.origin.desc': '優時科技(Kairos.ai)는 AI로 사람들에게 시간을 돌려준다는 단순한 아이디어에 몰두한 작은 팀에서 시작했습니다. 그 탐구는 제조업과 건설업의 업무 흐름 깊숙이 이어졌고, 우리는 계속해서 같은 병목을 발견했습니다 — 느리고 오류가 많은 수작업 철근 적산. 그래서 우리는 이를 해결하기 위해 SetTime를 만들었습니다.',
        'story.goal.title': '우리가 향하는 곳',
        'story.goal.desc': 'SetTime가 AEC 팀이 철근을 적산하는 표준적인 방법이 되기를 바라며, 필요로 하는 팀들을 위해 동일한 엄격함으로 AI 시스템, 백엔드 인프라, 데이터 플랫폼을 계속 구축하고자 합니다.',
...
const extraI18n = {
    ...
    ko: {
        ...
        'process.subtitle': 'SetTime가 철근 산출 전 과정을 자동화 — 수작업 집계도, 스프레드시트 오류도 없습니다.',
        'process.step1.title': '도면 업로드',
        'process.step1.desc': '구조 도면(PDF·CAD)을 올리면 SetTime가 평면·단면·상세를 분석합니다.',
        ...
        'pilot.desc': '실제 프로젝트에서 SetTime를 시범 도입할 AEC 기업을 모집합니다 — 도면을 제공하고 제품 개선에 참여하며 정식 출시 전 우선 이용 기회를 얻으세요.',
        ...
        'faq.tag': '자주 묻는 질문',
        'faq.title': '자주 묻는 질문',
        'faq.subtitle': 'SetTime와 Kairos.ai에 대해 자주 묻는 질문에 답합니다.',
        'faq.q1': 'SetTime란 무엇이며 철근을 어떻게 산출하나요?',
        'faq.a1': 'SetTime는 Kairos.ai가 개발한 엔드투엔드 AI 시스템으로, 시공 도면(PDF 또는 CAD)을 정확한 철근 산출 및 가공목록으로 자동 변환합니다. 컴퓨터 비전 모델이 도면에서 철근 호칭·간격·이음을 직접 읽어내어, 느리고 오류가 잦은 수작업 산출을 대체합니다.',
        'faq.q2': 'SetTime는 누구를 위한 것인가요?',
        'faq.a2': 'SetTime는 AEC(건축·엔지니어링·건설) 산업을 위해 만들어졌으며, 시공사, 철근 가공업체, 구조 엔지니어, 산출 팀이 더 빠르고 정확한 철근 산출과 더 짧은 입찰 준비 시간을 얻도록 돕습니다.',
        'faq.q3': 'SetTime는 무엇을 출력하나요?',
        'faq.a3': 'SetTime는 정확한 철근 수량·중량과 내보내기 가능한 철근 가공목록을 생성합니다 — 구매, 가공 일정 수립, 원가 산출에 바로 사용할 수 있습니다.',
