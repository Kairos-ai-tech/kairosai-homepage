...
const translations = {
    en: {
        ...
        'story.fact1.label': 'Headquartered in Taiwan',
        'story.fact2.label': 'Languages Supported',
        'story.fact3.label': 'Flagship Product — iTech',
    ...
    'zh-TW': {
        ...
        'story.fact1.label': '總部位於台灣',
        'story.fact2.label': '支援語言數',
        'story.fact3.label': '旗艦產品 — iTech',
    ...
    ja: {
        ...
        'story.fact1.label': '台湾に本社を置く',
        'story.fact2.label': '対応言語数',
        'story.fact3.label': '主力製品 — iTech',
    ...
    es: {
        ...
        'story.fact1.label': 'Sede en Taiwán',
        'story.fact2.label': 'Idiomas Compatibles',
        'story.fact3.label': 'Producto Insignia — iTech',
    ...
    it: {
        ...
        'story.fact1.label': 'Sede a Taiwan',
        'story.fact2.label': 'Lingue Supportate',
        'story.fact3.label': 'Prodotto di Punta — iTech',
        'products.itech.spec1Label': 'Input',
    ...
    fr: {
        ...
        'story.fact1.label': 'Siège à Taïwan',
        'story.fact2.label': 'Langues Prises en Charge',
        'story.fact3.label': 'Produit Phare — iTech',
    ...
    ko: {
        ...
        'story.fact1.label': '대만에 본사',
        'story.fact2.label': '지원 언어 수',
        'story.fact3.label': '대표 제품 — iTech',
    ...
    de: {
        ...
        'story.fact1.label': 'Hauptsitz in Taiwan',
        'story.fact2.label': 'Unterstützte Sprachen',
        'story.fact3.label': 'Flaggschiffprodukt — iTech',
